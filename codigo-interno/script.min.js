...
// Bootstrap tardío defensivo (script.min.js)
(()=>{try{if(!window.pfaSimulator&&(document.readyState==="interactive"||document.readyState==="complete")){window.pfaSimulator=new e();console&&console.log&&console.log("[PFA_bootstrap] Inicialización tardía directa (script.min.js)")}}catch(err){console&&console.error&&console.error("[PFA_bootstrap] Error en inicialización tardía:",err)}})();